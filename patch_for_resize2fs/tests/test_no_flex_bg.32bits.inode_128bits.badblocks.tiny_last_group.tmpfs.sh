...
$path_to_bin -f -i 524288 $image_file > ${script_name}_output_test_1
if [ $? -ne 1 ]
then
...
$path_to_bin -f -i 524288 $image_file > ${script_name}_output_test_2 || { echo 'modification 2 failed' ; exit 1; }
...
$path_to_bin -f -i 262144 $image_file > ${script_name}_output_test_4 || { echo 'modification 4 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 4 failed' ; exit 1; }

$path_to_bin -i 131072 $image_file > ${script_name}_output_test_5 || { echo 'modification 5 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 5 failed' ; exit 1; }

$path_to_bin -i 38912 $image_file > ${script_name}_output_test_6 || { echo 'modification 6 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 6 failed' ; exit 1; }

$path_to_bin -f -i 316928 $image_file > ${script_name}_output_test_7 || { echo 'modification 7 failed' ; exit 1; }
