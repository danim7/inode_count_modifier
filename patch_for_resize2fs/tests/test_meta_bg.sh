...
$path_to_bin -f -i 929152 $image_file > ${script_name}_output_test_1 || { echo 'modification 1 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 1 failed' ; exit 1; }

$path_to_bin -f -i 1835008 $image_file > ${script_name}_output_test_2 || { echo 'modification 2 failed' ; exit 1; }
...
$path_to_bin -i 458752 $image_file > ${script_name}_output_test_5 || { echo 'modification 5 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 5 failed' ; exit 1; }

$path_to_bin -i 135296 $image_file > ${script_name}_output_test_6 || { echo 'modification 6 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 6 failed' ; exit 1; }

$path_to_bin -f -i 1109248 $image_file > ${script_name}_output_test_7 || { echo 'modification 7 failed' ; exit 1; }
...
$path_to_bin -f -i 2787456 $image_file > ${script_name}_output_test_8 || { echo 'modification 8 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 8 failed' ; exit 1; }

$path_to_bin -f -i 5505024 $image_file > ${script_name}_output_test_9 || { echo 'modification 9 failed' ; exit 1; }
...
$path_to_bin -i 1376256 $image_file > ${script_name}_output_test_12 || { echo 'modification 12 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 12 failed' ; exit 1; }

$path_to_bin -i 405888 $image_file > ${script_name}_output_test_13 || { echo 'modification 13 failed' ; exit 1; }
e2fsck -vf $image_file  || { echo 'test 13 failed' ; exit 1; }

$path_to_bin -f -i 3327744 $image_file > ${script_name}_output_test_14 || { echo 'modification 14 failed' ; exit 1; }
