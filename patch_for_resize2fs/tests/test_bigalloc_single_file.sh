...
echo "launch test 1"
$path_to_bin -f -i 12 $image_file > ${script_name}_output_test_1 || { echo 'modification 1 failed' ; exit 1; }
echo "end test 1"
e2fsck -vf $image_file  || { echo 'test 1 failed' ; exit 1; }

echo "launch test 2"
$path_to_bin -f -i 196608 $image_file > ${script_name}_output_test_2 || { echo 'modification 2 failed' ; exit 1; }
echo "end test 2"
...
echo "launch test 4"
$path_to_bin -f -i 196608 $image_file > ${script_name}_output_test_4 || { echo 'modification 4 failed' ; exit 1; }
echo "end test 4"
